    ...
    return (
        <div className="h-full flex flex-col bg-white">
            ...
            <div className="border-b border-gray-200 px-6 py-4">
                <Link href="/" className="text-2xl font-bold whitespace-nowrap" style={{ color: '#1e3a6e' }}>
                    TL Market
                </Link>
            </div>
                ...
                {links.map((link) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className={`font-medium ${!open ? 'hidden' : ''}`}>{link.label}</span>
                        </Link>
                    )
                })}
            </nav>
            ...
            {/* User Info & Logout */}
            <div className={`border-t border-gray-200 p-4 space-y-3 ${!open ? 'hidden' : ''}`}>
